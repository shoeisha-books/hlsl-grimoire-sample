...
int WINAPI wWinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPWSTR lpCmdLine, int nCmdShow)
{
    ...
    g_camera3D->SetPosition({ 0.0f, 165.0f, 50.0f });
    g_camera3D->SetTarget({ 0.0f, 165.0f, 0.0f });    
    //////////////////////////////////////
    // ここから初期化を行うコードを記述する
    //////////////////////////////////////
    ...
    Model sphereModel;
    sphereModel.Init(modelInitData);

    Vector3 planePos = { 0.0f, 156.0f, 20.0f };
    ...
    while (DispatchWindowMessage())
    {
        ...
        sphereModel.UpdateWorldMatrix(planePos, g_quatIdentity, scale);
